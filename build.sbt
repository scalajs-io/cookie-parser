...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    description := "Cookie-parser API bindings for Scala.js",
    version := apiVersion,
...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/cookie-parser.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/cookie-parser.git</developerConnection>
        <url>github.com/scalajs-io/cookie-parser.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
